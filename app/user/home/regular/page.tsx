...
export default function() {
  ...
  const senddata1 = () => {
    const url = `/user/home/eventPayment?user_id=${encodeURIComponent(userId)}&event_id=${encodeURIComponent(eventId)}&reciver_id=${encodeURIComponent(reciverId)}&amount=299`;
    console.log("Redirecting to:", url);
    router.push(url);
  };

  const senddata2 = () => {
    const url = `/user/home/eventPayment?user_id=${encodeURIComponent(userId)}&event_id=${encodeURIComponent(eventId)}&reciver_id=${encodeURIComponent(reciverId)}&amount=99.00`;
    console.log("Redirecting to:", url);
    router.push(url);
  };
      ...
      <main className="flex-1 p-6 overflow-y-auto">
        <div className="container mx-auto max-w-10xl">
          <div className="flex flex-wrap items-center justify-between mb-6">
            <h1 className="text-2xl font-bold">Regular Movie Tickets</h1>
          </div>
              ...
              <div className="grid grid-cols-1 gap-4">
                <div className="bg-white rounded-lg shadow-md p-4 flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-3">
                    <div className="text-md text-gray-700 font-bold">$299</div>
                ...
                <div className="bg-white rounded-lg shadow-md p-4 flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-3">
                    <div className="text-md text-gray-700 font-bold">$99</div>
