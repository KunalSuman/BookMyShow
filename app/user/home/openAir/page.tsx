...
export default function() {
  ...
  const senddata1 = () => {
    const url = `/user/home/eventPayment?user_id=${encodeURIComponent(userId)}&event_id=${encodeURIComponent(eventId)}&reciver_id=${encodeURIComponent(reciverId)}&amount=999`;
    console.log("Redirecting to:", url);
    router.push(url);
  };

  const senddata2 = () => {
    const url = `/user/home/eventPayment?user_id=${encodeURIComponent(userId)}&event_id=${encodeURIComponent(eventId)}&reciver_id=${encodeURIComponent(reciverId)}&amount=700`;
    console.log("Redirecting to:", url);
    router.push(url);
  };
      ...
      <main className="flex-1 p-6 overflow-y-auto">
        <div className="container mx-auto max-w-10xl">
          <div className="flex flex-wrap items-center justify-between mb-6">
            <h1 className="text-2xl font-bold">Open Air Concert Tickets</h1>
          </div>
            ...
            <div className="flex-1 p-4">
              <div className="grid grid-cols-1 gap-4">
                <div className="bg-white rounded-lg shadow-md p-4 flex items-center justify-between">
                  <div>
                    <div className="font-semibold text-gray-700">North stand</div>
                    <div className="text-sm text-gray-500"></div>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="text-md text-gray-700 font-bold">$999</div>
                ...
                <div className="bg-white rounded-lg shadow-md p-4 flex items-center justify-between">
                  <div>
                    <div className="font-semibold text-gray-700">West stand</div>
                    <div className="text-sm text-gray-500"></div>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="text-md text-gray-700 font-bold">$700</div>
                ...
                <div className="bg-white rounded-lg shadow-md p-4 flex items-center justify-between">
                  <div>
                    <div className="font-semibold text-gray-700">East stand</div>
                    <div className="text-sm text-gray-500"></div>
                  </div>
                  <div className="flex items-center space-x-3">
