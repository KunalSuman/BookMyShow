    ...
    <div className="min-h-screen flex items-center justify-center p-8 bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500">
      <div className="bg-white rounded-lg shadow-lg p-8 w-full max-w-md">
        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="text-black px-2">Enter Company Name</div>
            <input
              type="text"
          ...
          <div>
            <div className="text-black px-2">Enter Phone Number</div>
            <input
              type="text"
          ...
          <div>
            <div className="text-black px-2">Initial Wallet Balance</div>
            <input
              type="number"
              placeholder="Balance"
              className="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:border-blue-500"
